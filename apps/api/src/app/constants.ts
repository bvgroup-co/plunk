...
export const POSTAL_API_KEY = EMAIL_PROVIDER_IS_POSTAL
  ...
  : validateEnv('POSTAL_API_KEY', '');
export const POSTAL_DOMAIN_API_BASE_URL = validateEnv<string>('POSTAL_DOMAIN_API_BASE_URL', '');
export const POSTAL_DOMAIN_API_KEY = validateEnv<string>('POSTAL_DOMAIN_API_KEY', '');
export const POSTAL_DOMAIN_SERVER_ID = validateEnv<string>('POSTAL_DOMAIN_SERVER_ID', '');
export const POSTAL_DOMAIN_SERVER_PERMALINK = validateEnv<string>('POSTAL_DOMAIN_SERVER_PERMALINK', '');
