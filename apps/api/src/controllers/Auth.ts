...
import {BadRequest, HttpException, NotAuthenticated, RateLimitError} from '../exceptions/index.js';
...
function rejectDisabledPasswordAuth(): never {
  throw new HttpException(404, 'Password authentication is disabled');
}

function assertPasswordAuthEnabled() {
  if (!PASSWORD_AUTH_ENABLED) {
    rejectDisabledPasswordAuth();
  }
}
