...
Stock Postal does not provide a supported API for Plunk to create, refresh, or delete Postal domains. In Postal mode, create and verify sender domains in Postal first and use the DNS records shown in Postal. Plunk intentionally fails domain add rather than showing synthetic DNS records.
