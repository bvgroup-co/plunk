            ...
            <CardContent className="p-8">
              <div className="flex flex-col items-center gap-4 text-center">
                <div className="flex flex-col gap-1.5">
                  <h1 className="text-xl font-bold tracking-tight">Password login is disabled</h1>
                  <p className="text-sm text-neutral-500">
                    This Plunk instance uses organization single sign-on. Continue from the login page.
                  </p>
                </div>
