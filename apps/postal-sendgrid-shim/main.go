...
func main() {
	...
	forwarder := webhook.NewForwarder(store, cfg.PlunkWebhookBaseURL, httpClient, cfg.ForwardAttempts, cfg.ForwardBackoff, cfg.WebhookSigningEnabled, cfg.WebhookSigningKey)
