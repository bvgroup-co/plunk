/**
 * Default CSS for Plunk visual-editor email content.
 *
 * Keep this synchronized with the existing email wrapper mechanism in the API and web preview.
 */
export const DEFAULT_EMAIL_CSS = `    /* Base reset */
