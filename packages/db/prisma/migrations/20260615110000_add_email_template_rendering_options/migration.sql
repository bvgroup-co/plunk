-- CreateEnum
CREATE TYPE "TemplateMode" AS ENUM ('HTML', 'PLAIN_TEXT');

-- CreateEnum
CREATE TYPE "TemplateCssMode" AS ENUM ('GLOBAL', 'CUSTOM');

-- AlterTable
ALTER TABLE "projects" ADD COLUMN "globalEmailCss" TEXT NOT NULL DEFAULT '    /* Base reset */
...
-- AlterTable
ALTER TABLE "templates" ADD COLUMN "mode" "TemplateMode" NOT NULL DEFAULT 'HTML',
